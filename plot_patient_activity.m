...
[dSpiking,mnSpiking,~,semSpiking] = patient_activity( model,pc,spikingSOZ);
[dNonSpiking,mnNonSpiking,~,semNonSpiking] = patient_activity( model,pc,nonspikingSOZ);
[dAcross,mnAcross,~,semAcross] = patient_activity( model,pc,nodes);
[dGlobal,mnGlobal,~,semGlobal] = patient_activity( model,pc,1:n);
